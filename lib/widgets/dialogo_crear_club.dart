...
class _DialogoCrearClubState extends State<DialogoCrearClub> {
  ...
  Widget build(BuildContext context) {
    return Dialog(
      shape: RoundedRectangleBorder(
        ...
        side: BorderSide(color: morado, width: 1),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                ...
                validator: (value) =>
                    value?.trim().isEmpty ?? true ? "El nombre es obligatorio" : null,
              ),
              const SizedBox(height: 15),

              // Libro a leer (con búsqueda)
              TextFormField(
                controller: _libroController,
                readOnly: _buscandoEnCatalogo,
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: "Autor",
                  hintText: _bookIdSeleccionado != null ? "Del catálogo" : "Obligatorio para libros manuales",
                ...
                validator: (value) {
                  if (_bookIdSeleccionado == null && (value?.trim().isEmpty ?? true)) {
              ...
              if (_customClubImageUrl != null && _customClubImageUrl!.isNotEmpty) ...[
              ...
              DropdownButtonFormField<int>(
                ...
                items: List.generate(19, (i) => i + 2).map((n) {
                  return DropdownMenuItem(value: n, child: Text("$n miembros"));
                }).toList(),
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: const Text("Crear Club", style: TextStyle(fontWeight: FontWeight.bold)),
                  ),
                ],
              ),
            ],
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: _inputDecoration(label).copyWith(
        hintText: hint,
        suffixIcon: icon != null ? Icon(icon, color: morado) : null,
      ),
      validator: validator,
    );
  }
  ...
  InputDecoration _inputDecoration(String label) {
    return InputDecoration(
      labelText: label,
      labelStyle: TextStyle(color: morado, fontWeight: FontWeight.w500),
      border: OutlineInputBorder(borderRadius: BorderRadius.circular(10)),
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(10),
        borderSide: BorderSide(color: naranja, width: 2),
  ...
  void _validarYGuardar() async {
    ...
    if (_bookIdSeleccionado == null && _autorController.text.trim().isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("⚠️ Para libros manuales, por favor escribe también el autor"),
    ...
    if (user != null && _bookIdSeleccionado != null) {
      ...
      if (userBookSnapshot.docs.isNotEmpty) {
        ...
        if (shelf == 'Leído' && dateFinished != null) {
          ...
          final String fechaFormateada = DateFormat('dd/MM/yyyy').format(fechaFin);
          ...
          final confirmar = await showDialog<bool>(
            ...
            builder: (dialogContext) => AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  Text("Ya terminaste este libro el $fechaFormateada.", style: const TextStyle(fontWeight: FontWeight.w500)),
                  const SizedBox(height: 10),
                  Text("Al crear el club, el libro se moverá a 'Leyendo' y el progreso se reiniciará a 0%.", style: TextStyle(color: Colors.grey[700])),
                  const SizedBox(height: 10),
                  const Text("¿Deseas continuar?", style: TextStyle(fontStyle: FontStyle.italic)),
                ],
              ),
              actions: [
 ...
 void _mostrarBusquedaLibrosParaClub() async {
    // Llamamos al mismo helper genérico
    ...
    if (resultado != null && mounted) {
      setState(() {
        ...
        _portadaSeleccionado = resultado['cover'] ?? ''; // Ajusta el nombre de tu variable si es diferente
